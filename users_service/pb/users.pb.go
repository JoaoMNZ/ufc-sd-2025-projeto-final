...
type CreateUserRequest struct {
	...
	UserType      UserType               `protobuf:"varint,5,opt,name=user_type,json=userType,proto3,enum=users.UserType" json:"user_type,omitempty"`
...
func (x *CreateUserRequest) GetToken() int32 {
	if x != nil {
		return x.Token
	}
	return 0
...
func (x *GetUserRequest) GetToken() int32 {
	if x != nil {
		return x.Token
	}
	return 0
...
func (x *ListUsersRequest) GetToken() int32 {
	if x != nil {
		return x.Token
	}
	return 0
...
func (x *UpdateUserRequest) GetToken() int32 {
	if x != nil {
		return x.Token
	}
	return 0
...
func (x *DeleteUserRequest) GetToken() int32 {
	if x != nil {
		return x.Token
	}
	return 0
...
const file_proto_users_proto_rawDesc = "" +
	...
	"\bpassword\x18\x05 \x01(\tR\bpassword\"\x7f\n" +
	...
	"\x10AuthenticateUser\x12\x12.users.AuthRequest\x1a\x13.users.AuthResponse\x125\n" +
...
var file_proto_users_proto_depIdxs = []int32{
	...
	0,  // 1: users.AuthResponse.user_type:type_name -> users.UserType
	0,  // 2: users.ListUsersRequest.user_type:type_name -> users.UserType
	8,  // 3: users.ListUsersResponse.users:type_name -> users.UserResponse
	0,  // 4: users.UserResponse.user_type:type_name -> users.UserType
	1,  // 5: users.UserService.CreateUser:input_type -> users.CreateUserRequest
	2,  // 6: users.UserService.AuthenticateUser:input_type -> users.AuthRequest
	4,  // 7: users.UserService.GetUser:input_type -> users.GetUserRequest
	...
	8,  // 11: users.UserService.CreateUser:output_type -> users.UserResponse
	3,  // 12: users.UserService.AuthenticateUser:output_type -> users.AuthResponse
